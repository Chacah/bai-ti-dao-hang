...
<div id="header_son">
  ...
  <div id="baidu"></div>
	<form action="http://www.baidu.com/s" method="get" target="_blank">
	  <input  id="search" name="wd"type="text" class="int"autocomplete="off" rel="kw" index="1"value="百替生物"/>
	  <input  class="searchint" id="baidubb" type="submit"  value="百度一下" rel="btn" />
	...
	<tr>
		...
		<table width="650" border="0">
			<tr>
				...
				<{/foreach}>
				<td align="center" nowrap="nowrap"><a href="<{$item.url}>">更多
				&raquo;</a></td>
			</tr>
		</table>
		</td>
