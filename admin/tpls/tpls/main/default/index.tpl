            ...
            <div id="js_type_<{$search_class2.classid}>" <{if $search_class2.is_default!=1}> style="display:none;"<{/if}>>
                ...
                <div class="sf">
                    <form action="http://116.com/s" method="get" target="_blank">
                        <a href="http://116.com" id="sf_label" rel="lk"><img src="static/images/s/116.gif" width="105" height="35" rel="img" /></a><input type="text" name="q" class="int" autocomplete="off" rel="kw"/><input class="searchint" type="submit" value="搜索" rel="btn" />
                        <div class="ctrl">
                    ...
                    <div id="tb">
                        ...
                        <div id="tb4" class="tbox" style="margin-left:-5px;">
                            <form class="plane" action="http://cz.115.com/" method="post" target="_blank">
                                ...
                                <p style="text-align:center;"><span class="red">1</span>分钟到账&nbsp;&nbsp;最低<span class="red">9.85</span>折&nbsp;&nbsp;&nbsp;</p>
                            </form>
                        </div>
                    </div>
                </div>
